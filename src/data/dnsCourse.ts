...
export const DNS_COURSE: DNSCourseDay[] = [
  ...
  },
  {
    ...
    weekTitle: '3 Months Prone → 4.5 Months Prone → Creeping Prep',
    weekPhase: 'Foundation',
    dayTitle: 'Single Step Creep',
    description: 'Isolate the weight transfer and rotational challenge before full locomotion.',
    videoId: '1215647702',
    isPremium: true,
  },
  {
    ...
    weekTitle: '3 Months Prone → 4.5 Months Prone → Creeping Prep',
    weekPhase: 'Foundation',
    dayTitle: 'Creeping Forwards and Backwards',
    description: 'Creeping forwards and backwards.',
    videoId: '1215647704',
    isPremium: true,
  },
  ...
  // ============ WEEK 5: High Oblique Sit / S Position (Integration) ============
  {
    ...
    dayTitle: '"Twisted Prone" — Spinal Rotation in Low Oblique Sit',
    description: 'Anchors people coming from Week 3, recontextualizes the position as a rotational challenge.',
    videoId: null,
    isPremium: true,
  },
  {
  ...
  },
  {
    ...
    weekTitle: 'High Oblique Sit / S Position',
    weekPhase: 'Integration',
    dayTitle: 'Low Oblique to High Oblique Transition',
    description: 'Importance of hand loading and shoulder centration. Straight spine, proper alignment.',
    videoId: null,
    isPremium: true,
  },
  {
    ...
    description: 'Familiar movement pattern from Week 3 now arriving at a higher, more demanding destination.',
    videoId: null,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'High Oblique Sit / S Position',
    weekPhase: 'Integration',
    dayTitle: 'S Position Transitions Side to Side',
    description: 'One hip internal rotation, one external rotation. Challenge: transition between sides without compensating with the lumbar spine. Working in the transverse plane — the last plane of stabilization to develop developmentally and the most commonly undertrained. Compensations to watch: lumbar rotation compensating for hip rotation, losing the arch, breath holding.',
    videoId: null,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'High Oblique Sit / S Position',
    weekPhase: 'Integration',
    dayTitle: 'S Position In and Out of Tripod',
  ...
  },
  {
    ...
    description: 'Regular high oblique sit to bear.',
    videoId: null,
    isPremium: true,
  },
