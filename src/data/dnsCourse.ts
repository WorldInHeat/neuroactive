...
export const DNS_COURSE: DNSCourseDay[] = [
  ...
  },
  {
    ...
    weekTitle: '3 Months Prone → 4.5 Months Prone → Creeping Prep',
    weekPhase: 'Foundation',
    dayTitle: 'Contralateral Plank Progression',
    description: 'Progress the 4.5-month prone position into a contralateral plank under load, maintaining whole-body control without dropping the hips or sagging through the low back.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: '3 Months Prone → 4.5 Months Prone → Creeping Prep',
    weekPhase: 'Foundation',
    dayTitle: 'Creeping: Single-Step Mechanics and Check-Ins',
    description: 'Single-step weight transfer and rotational mechanics, with check-ins on earlier patterns and a bonus standing posture cue.',
    hasVideo: true,
    isPremium: true,
  },
  ...
  },
  {
    ...
    weekTitle: 'Tripod → High Kneel to Sit',
    weekPhase: 'Integration',
    dayTitle: 'Glute Bridge Wheel Turn + Tripod Reach and Rotation',
    description: "Glute bridge 'wheel turn,' plus reaching and rotating in tripod — forward and up, threading the needle.",
    hasVideo: true,
    isPremium: true,
  },
  {
  ...
  },
  {
    ...
    weekTitle: 'Tripod → High Kneel to Sit',
    weekPhase: 'Integration',
    dayTitle: 'Posterior Turn Elevation + Foot Tripod',
    description: 'Posterior turn elevation and foot tripod loading: on your mark, get set, go.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Tripod → High Kneel to Sit',
    weekPhase: 'Integration',
    dayTitle: 'Tripod to High Kneeling — Uprighting with the Wheel Turn',
    description: "Uprighting from tripod to high kneeling using the 'wheel turn' — driven by the glutes, not the back.",
    hasVideo: true,
    isPremium: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Weekly check-in and high-kneeling-to-stand variations.',
    hasVideo: true,
    isPremium: true,
  },
  ...
  // ============ WEEK 7: Crawling (Integration) ============
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Crawling Mechanics: Contralateral Pattern',
    description: 'Learn the single-step contralateral crawling pattern, avoid an ipsilateral pattern, and reassess shoulder mobility and ease of crawling.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Crawling Timing: Contralateral, Same-Time Steps',
    description: 'Practice coordinating the opposite arm and leg at the same time, then compare that timing with crawling patterns seen in animals and swimming.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Pelvis-Driven Cat/Cow + Upper-Back Mobilization',
    description: 'Drive the movement from the pelvis, allow the head to follow last, and add focused upper-thoracic mobilization.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Spider Position: Static Hold and Plank Challenge',
    description: 'Establish the DNS spider position and hold it as a controlled, plank-like whole-body challenge.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Spider Position: Rotation and Lateral Flexion',
    description: 'Add thread-the-needle and reaching variations to challenge spinal rotation and lateral flexion from the spider position.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: "Under the Wire: Child's Pose → Spider → Push-Up",
    description: 'Move from child\'s pose through the spider position and into a push-up using the "under the wire" transition.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Crawling',
    weekPhase: 'Integration',
    dayTitle: 'Pressurized Hollow in Quadruped + Crawling Check-In',
    description: 'Revisit the pressurized hollow in quadruped, then repeat the crawling challenge and compare how the pattern feels.',
    hasVideo: true,
    isPremium: true,
  },
  ...
  // ============ WEEK 8: Bear (Integration) ============
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Bear Position: Low and High Bear Basics',
    description: 'Establish the low and high bear positions while maintaining pressure, alignment, and whole-body control.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Bear-to-Stand Transition: Pelvis Wheel',
    description: 'Move from bear position to standing by using the DNS pelvis “wheel” to organize the transition from the ground up.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Bear Position Stability: Contralateral Control',
    description: 'Challenge stability in bear position while coordinating contralateral control without losing trunk position.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Bear Hold to Bird Dog: Contralateral Reach',
    description: 'Progress from a stable bear hold into a contralateral bird dog reach while controlling rotation through the trunk and pelvis.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Contralateral Bear Crawl: Forward and Backward',
    description: 'Coordinate opposite-arm-and-leg movement while crawling forward and backward without losing the bear-position foundation.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Pressurized Hollow in Bear Position',
    description: 'Apply the pressurized hollow in bear position to maintain abdominal pressure and trunk control under load.',
    hasVideo: true,
    isPremium: true,
  },
  {
    ...
    weekTitle: 'Bear',
    weekPhase: 'Integration',
    dayTitle: 'Bear Twister Transition + Bear Bird Dog Check-In',
    description: 'Learn the bear twister transition, then revisit the bear bird dog to assess contralateral control and overall progress.',
    hasVideo: true,
    isPremium: true,
  },
